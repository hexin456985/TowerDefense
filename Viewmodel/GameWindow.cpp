    ...
    m_gameWin(false)
{
    ...
    back_bin->setIconSize(QSize(150,150));
    back_bin->move(1140,-220);
    ...
    Button * tower1 = new Button(":/Resource/images/Arrowtower0.png");
    tower1->setParent(this);
    tower1->setIconSize(QSize(150,150));
    tower1->move(800,650);
    connect(tower1,&Button::clicked,this,[=](){
        tower1->buttondown();
        tower1->buttonup();
        towertype=1;
        up=0;
    ...
    Button * tower2 = new Button(":/Resource/images/Magictower0.png");
    tower2->setParent(this);
    tower2->setIconSize(QSize(150,150));
    tower2->move(980,684);
    connect(tower2,&Button::clicked,this,[=](){
        tower2->buttondown();
        tower2->buttonup();
        towertype=2;
        up=0;
    ...
    Button * tower3 = new Button(":/Resource/images/Demontower0.png");
    tower3->setParent(this);
    tower3->setIconSize(QSize(150,150));
    tower3->move(1152,704);
    connect(tower3,&Button::clicked,this,[=](){
        tower3->buttondown();
        tower3->buttonup();
        towertype=3;
        up=0;
    ...
    Button * tower4 = new Button(":/Resource/images/Canontower0.jpg");
    tower4->setParent(this);
    tower4->setIconSize(QSize(130,150));
    tower4->move(1233,640);
    connect(tower4,&Button::clicked,this,[=](){
        tower4->buttondown();
        tower4->buttonup();
        towertype=4;
        up=0;
    ...
    Button * play = new Button(":/Resource/images/Button.png");
    play->setParent(this);
    play->move(1100,1010);

    Button * upgrade_bin = new Button(":/Resource/images/Upgrade.png");
    upgrade_bin->setParent(this);
    upgrade_bin->setIconSize(QSize(120,120));
    upgrade_bin->move(900,-85);
    connect(upgrade_bin,&Button::clicked,this,[=](){
    ...
    Button * deletetower_bin = new Button(":/Resource/images/Deletetower.png");
    deletetower_bin->setParent(this);
    deletetower_bin->setIconSize(QSize(120,120));
    deletetower_bin->move(1105,-30);
    connect(deletetower_bin,&Button::clicked,this,[=](){
...
void GameWindow::mousePressEvent(QMouseEvent *event)
{
    ...
    while (it != m_towerPositionsList.end())
    {
        ...
        if( it->containPoint(pressPos) && it->hasTower() && towertype==0 && up==1 && del==0)
        {
             ...
             {
                 m_towersList.removeOne(it->m_tower);
                 it->m_tower = new Tower2(it->centerPos(), this);
                 m_towersList.push_back(it->m_tower);
                 m_playrGold -= UpdateTowerCost;
                 update();
             ...
             {
                 m_towersList.removeOne(it->m_tower);
                 it->m_tower = new Tower3(it->centerPos(), this);
                 m_towersList.push_back(it->m_tower);
                 m_playrGold -= UpdateTowerCost;
                 update();
             ...
             {
                 m_towersList.removeOne(it->m_tower);
                 it->m_tower = new Tower4(it->centerPos(), this);
                 m_towersList.push_back(it->m_tower);
                 m_playrGold -= UpdateTowerCost;
                 update();
...
{
    m_audioPlayer->playSound(BaseAttackedSound);
    m_playerHp -= damage;
    if (m_playerHp <= 0)
        doGameOver();
}
